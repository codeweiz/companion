...
/**
 * Companion navigation bar item with icon and label content slots. Wraps Material 3
 * [NavigationBarItem].
 *
...
/**
 * Companion navigation bar with content slot. Wraps Material 3 [NavigationBar].
 *
...
/**
 * Companion navigation rail item with icon and label content slots. Wraps Material 3
 * [NavigationRailItem].
 *
 * @param selected Whether this item is selected.
 * @param onClick The callback to be invoked when this item is selected.
...
/**
 * Companion navigation rail with header and content slots. Wraps Material 3 [NavigationRail].
 *
...
/**
 * Companion navigation suite scaffold with item and content slots.
...
/**
 * Companion navigation default values.
 */
