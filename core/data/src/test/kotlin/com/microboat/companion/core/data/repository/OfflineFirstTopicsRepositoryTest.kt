...
class OfflineFirstTopicsRepositoryTest {
    ...
    private lateinit var niaPreferences: AppPreferencesDataSource
    ...
    fun setup() {
        ...
        niaPreferences = AppPreferencesDataSource(InMemoryDataStore(UserPreferences.getDefaultInstance()))
